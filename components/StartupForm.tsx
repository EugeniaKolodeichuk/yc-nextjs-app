    ...
    const handleFormSubmit = async (prevState: any, formData: FormData) => {
        try {
            ...
            if (error instanceof z.ZodError) {
                ...
                return { ...prevState, error: "Validation failed. Please check your input.", status: "ERROR" };
            }
            toast({
                title: "Validation Error",
            ...
            return { ...prevState, error: "An unexpected error occurred. Please try again later.", status: "ERROR" };
        }
    };
